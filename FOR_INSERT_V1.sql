...
BEGIN
   FOR cliente_data IN (
      SELECT 
         ...
         F.CARGO,
         F.SITE_WEB
      FROM J7_CLIENTE_DATA_TEMP_FILE F
      LEFT JOIN J7_CLIENTE A ON A.WHATSAPP = F.WHATSAPP
      WHERE A.WHATSAPP IS NULL
   ) LOOP
      BEGIN
         INSERT INTO J7_CLIENTE (
         ...
         INSERT INTO J7_CLIENTE_INFORMACAES (
            ID_CLIENTE_FK,
            "NOME/RAZAO_SOCIAL",
            FANTASIA,
            "CNPJ/CPF",
...
BEGIN
   FOR cliente_data IN (
      ...
      BEGIN
         ...
         UPDATE J7_CLIENTE_INFORMACAES SET
